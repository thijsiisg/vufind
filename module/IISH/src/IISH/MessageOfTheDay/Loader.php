        ...
        try {
			...
			if ($this->getLang() == 'nl') {
				return array(
					...
					'content' => 'In lijn met het landelijke beleid met betrekking tot het coronavirus is het IISG voor het publiek gesloten van maandag 16 maart tot en met 28 april 2020.',
					'lang'    => $this->getLang()
				);
			}
			...
			return array(
				...
				'content' => 'Following the national policy concerning the coronavirus, IISH will be closed to the public from Monday 16 March until 28 April 2020.',
				'lang'    => $this->getLang()
			);
